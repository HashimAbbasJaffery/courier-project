                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item <?php echo $current_page == '/Leopard_courier/shipper_advice.php' ? 'active' : ''; ?>">
                                <Link :href="route('shipper.advice')" class="menu-link">
                                    <div>Shipper Advice</div>
                                </Link>
                            </li>
                            <li class="menu-item <?php echo $current_page == '/bookings/expanded' ? 'active' : ''; ?>">
                                <Link :href="route('booking.expanded')" class="menu-link">
                                    <div>Expanded Bookings</div>
                                </Link>
                            </li>
                        </ul>
                    </li>
